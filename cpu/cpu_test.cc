...
TEST (ClockCycleTest, LDA_LoadAccumulator) {
{// Immediate
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xA9); // immediate
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xA5); // zero page
    int expected = cpu.get_cycles() + 3;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xB5); // zero page X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xAD); // absolute
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xBD); // absolute X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xB9); // absolute Y
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, LDY_LoadYRegister) {
  {// Immediate
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xA0); // immediate
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero Page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xA4); // zero page
    int expected = cpu.get_cycles() + 3;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xB4); // zero page X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xAC); // absolute
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xBC); // absolute X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, LSR_LogicalShiftRight) {
  {// Accumulator
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x4A); // accumulator
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero Page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x46); // zero page
    int expected = cpu.get_cycles() + 5;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x56); // zero page X
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x4E); // absolute
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x5E); // absolute X
    int expected = cpu.get_cycles() + 7;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, NOP_NoOperation) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0xEA); // nop
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}

TEST (ClockCycleTest, ORA_LogicalInclusiveOr) {
{// Immediate
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x09); // immediate
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x05); // zero page
    int expected = cpu.get_cycles() + 3;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x15); // zero page X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x0D); // absolute
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x1D); // absolute X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x19); // absolute Y
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Indirect X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x01); //indirect X
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Indirect Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x11); //indirect Y
    int expected = cpu.get_cycles() + 5;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, ROL_RotateLeft) {
  {// Accumulator
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x2A); // accumulator
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero Page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x26); // zero page
    int expected = cpu.get_cycles() + 5;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x36); // zero page X
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x2E); // absolute
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x3E); // absolute X
    int expected = cpu.get_cycles() + 7;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, SBC_SubtractWithCarry) {
  {// Immediate
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xE9); // immediate
    int expected = cpu.get_cycles() + 2;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xE5); // zero page
    int expected = cpu.get_cycles() + 3;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xF5); // zero page X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xED); // absolute
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xFD); // absolute X
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xF9); // absolute Y
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Indirect X
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xE1); // indirect X
    int expected = cpu.get_cycles() + 6;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Indirect Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0xF1); // indirect Y
    int expected = cpu.get_cycles() + 5;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, SEI_SetInterruptDisable) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0x78); // sei
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}
...
TEST (ClockCycleTest, STX_StoreXRegister) {
  {// Zero page
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x86); // zero page
    int expected = cpu.get_cycles() + 3;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Zero page Y
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x96); // zero page Y
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
  {// Absolute
    CPU cpu;
    int pc = cpu.get_pc();
    cpu.set_memory(pc, 0x8E); // absolute
    int expected = cpu.get_cycles() + 4;
    cpu.step();
    EXPECT_EQ(cpu.get_cycles(), expected);
  }
...
TEST (ClockCycleTest, TAX_TransferAccumulatorToX) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0xAA); // tax
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}

TEST (ClockCycleTest, TAY_TransferAccumulatorToY) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0xA8); // tay
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}

TEST (ClockCycleTest, TSX_TransferStackPointerToX) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0xBA); // tsx
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}

TEST (ClockCycleTest, TXA_TransferXToAccumulator) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0x8A); // txa
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}
...
TEST (ClockCycleTest, TYA_TransferYToAccumulator) {
  CPU cpu;
  int pc = cpu.get_pc();
  cpu.set_memory(pc, 0x98); // tya
  int expected = cpu.get_cycles() + 2;
  cpu.step();
  EXPECT_EQ(cpu.get_cycles(), expected);
}
